...
if __name__ == '__main__':
	...
	# print(2*apothem)
	# print(2*apothem)
	# print(0, IsometricPoint(grid, 0, 3/2*apothem).distance_from(IsometricPoint(grid_prime, 0, 3/2*apothem)))
	# print(apothem, IsometricPoint(grid, 1/2*apothem, 5/4*apothem).distance_from(IsometricPoint(grid_prime, 1/2*apothem, 5/4*apothem)))
	# print(2*apothem, IsometricPoint(grid, apothem, apothem).distance_from(IsometricPoint(grid_prime, apothem, apothem)))
	# print(4*apothem, IsometricPoint(grid, 2*apothem, 1/2*apothem).distance_from(IsometricPoint(grid_prime, 2*apothem, 1/2*apothem)))
	# print(6*apothem, IsometricPoint(grid, 3*apothem, 0).distance_from(IsometricPoint(grid_prime, 3*apothem, 0)))

	print(isometric_distance(10, 5)**2)
